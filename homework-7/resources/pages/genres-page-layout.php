...
<div class="movie-list">
	<?php foreach($movies as $movie): ?>
		<?php if (isset($genres[$code]) && in_array($genres[$code], $movie['genres'], true)):?>
			<div class="movie-list--item">
				...
				<div class="movie-list--item-bottom">
					...
					<div class="movie-list--item-info"><div class="movie-list--item-info"><?= implode(', ',$movie['genres']) ?></div></div>
				</div>
			</div>
		<?php endif;?>
	<?php endforeach; ?>
